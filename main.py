"""
TikTok Hook Writer — First 3 seconds that stop the scroll
...
DB_FILE      = "tiktok_hook_writer.db"
SYSTEM_PROMPT = "You are an expert TikTok Hook Writer assistant. Describe your video concept. Get 10 hook options for the first 3 seconds."

app = FastAPI(title="TikTok Hook Writer")
...
<title>TikTok Hook Writer</title>
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">TikTok Hook Writer</div>
    <div class="auth-sub">First 3 seconds that stop the scroll</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">TikTok Hook Writer</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>TikTok Hook Writer</em><br>First 3 seconds that stop the scroll</h1>
    <p>Describe your video concept. Get 10 hook options for the first 3 seconds. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <button class="card-action" onclick="clearForm()">Clear</button>
        ...
        <div class="field">
      <label for="field-video_concept">Video Concept</label>
      <textarea id="field-video_concept" placeholder="Enter video concept..." required></textarea>
    </div>
    <div class="field">
      <label for="field-audience">Audience</label>
      <input type="text" id="field-audience" placeholder="e.g. your audience">
    </div>
    <div class="field">
  ...
  <footer>
    <div class="foot-note">TikTok Hook Writer &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert TikTok Hook Writer assistant. Describe your video concept. Get 10 hook options for the first 3 seconds.",
  promptTemplate: "Video Concept: {{video_concept}}\\nAudience: {{audience}}\\nStyle: {{style}}",
  resultFormat:   'list', // text | list | steps
  resultConfig:   {"label": "Result", "copyable": true},
  inputs:         [{"id": "video_concept", "label": "Video Concept", "type": "textarea", "placeholder": "Enter video concept...", "required": true}, {"id": "audience", "label": "Audience", "type": "text", "placeholder": "e.g. your audience", "required": false}, {"id": "style", "label": "Style", "type": "select", "options": ["Creative", "Descriptive", "Metaphorical", "Short & punchy", "Professional"], "required": false}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "TikTok Hook Writer", "ai_ready": bool(GROQ_API_KEY)}
